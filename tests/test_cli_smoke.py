...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("03-00-000-000-0001", ["--venue", "assessor", "--today", "2026-05-01"]),
        ("03-00-000-000-0020", ["--venue", "assessor", "--today", "2026-05-01"]),
        ("03-00-000-000-0030", ["--venue", "assessor", "--today", "2026-05-01"]),
        (
            "03-00-000-000-0001",
